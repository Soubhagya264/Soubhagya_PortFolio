          ...
          <div className="order-2 lg:order-1">
            ...
            <ScrollAnimation delay={400}>
              <h2 className="text-2xl md:text-3xl font-heading text-muted-foreground mb-6">
                <AnimatedText text="AI Software Engineer" />
              </h2>
            </ScrollAnimation>

            <ScrollAnimation delay={600}>
              <p className="text-lg text-muted-foreground max-w-lg mb-8 border-l-2 border-purple/50 pl-4">
                I build exceptional digital products with modern tech, combining responsive front-end design,
                scalable back-end systems, and powerful AI integration.
              </p>
            </ScrollAnimation>
